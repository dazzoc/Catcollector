...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        form = UserCreationForm(request.POST) # <= fills out the form with values form request
        if form.is_valid():
...
def cats_detail(request, cat_id):
    ...
    # redirect user if they try to access other user cats
...
class CatCreate(LoginRequiredMixin, CreateView):
    model = Cat
    # mite have to change to tuple not all 
    fields = ('name', 'breed', 'discription', 'age')
